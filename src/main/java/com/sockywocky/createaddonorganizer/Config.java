...
public class Config {
    ...
    public static void resetAllToDefault() {
        applyAppearance(DEFAULT_BANNER_COLOR.getDefault(), SECTION_COLORS.getDefault(), BANNERS.getDefault(),
                ...
                BOX_COLORS.getDefault(), DEFAULT_TEXT_COLOR.getDefault(), TEXT_COLORS.getDefault(),
    ...
    public static void applyAppearance(int bannerColor, List<? extends String> sectionColors, List<? extends String> banners,
            ...
            int textColor, List<? extends String> textColors, boolean twoTone, int textSecondaryColor,
            List<? extends String> textSecondaryColors, List<? extends String> highlightColors, boolean showAllBanners,
            List<? extends String> extraBannerPool) {
